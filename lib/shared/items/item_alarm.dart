    ...
    return BlocBuilder<HomeBloc, HomeState>(builder: (context, state) {
      ...
      return BlocProvider(
          ...
          child: Column(
            ...
            children: [
              AlarmNotification(onCancel: () {
                context
                    .read<HomeBloc>()
                    .add(OnCancelAlarmEvent(widget.alarm, isAlarmActive));
              }),
              ListTile(
                onLongPress: () {
                  context
                ...
                title: RichText(
                    ...
                    text: TextSpan(
                        text:
                            StringUtils.formatTime(widget.alarm.alarmDateTime),
